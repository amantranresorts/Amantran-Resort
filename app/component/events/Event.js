        ...
        <div className="text-center mb-16">
          <div className="flex justify-center mb-4">
            <div className="bg-gradient-to-r from-amber-400 to-amber-500 text-white px-6 py-2 rounded-full inline-flex items-center gap-2 shadow-lg">
              ...
              <span className="text-sm font-semibold font-cinzel tracking-wider uppercase">
                Premium Events & Celebrations
              </span>
            </div>
          </div>

          <h2 className="text-lg font-light font-raleway text-amber-600 tracking-widest uppercase border-b border-amber-200 pb-2 mb-4">
            Moments that Rise Above Time
          </h2>

          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight font-raleway">
          ...
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed max-w-4xl mx-auto font-light font-open-sans">
        ...
        {events.map((eventGroup, index) => (
          <div key={index} className="mb-20">
            ...
            <div className="text-center mb-12">
              <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-raleway">
                {eventGroup.location}
              </h3>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="md:w-1/2 w-full p-8 flex flex-col justify-between bg-gradient-to-br from-amber-50 to-white group-hover:from-amber-100 transition-all duration-500">
                      <div>
                        <h4 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 font-raleway">
                          {event.title}
                        </h4>
                        <p className="text-gray-700 leading-relaxed mb-6 text-lg font-light font-open-sans">
                          {event.description}
                        </p>
                      </div>

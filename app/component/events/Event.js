      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-16 bg-gradient-to-r from-amber-500/10 to-amber-600/10 rounded-2xl p-12 border border-amber-200">
          ...
          <Link
            ...
            className="bg-gradient-to-r from-amber-500 to-amber-600 text-white font-bold px-10 py-4 rounded-full shadow-lg hover:from-amber-600 hover:to-amber-700 transform hover:scale-105 transition-all duration-300 uppercase tracking-wider text-lg flex items-center justify-center gap-3 group no-underline"
          >
            <svg

                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      4QQM+V9R, Tarapith Road, Belia, Rampurhat, West Bengal
                      731233
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="text-gray-700">
                      <a
                        href="tel:+919147389021"
                        className="hover:underline block"
                      >
                        +91 9147389021
                      </a>
                      <a
                        href="tel:+919147389020"

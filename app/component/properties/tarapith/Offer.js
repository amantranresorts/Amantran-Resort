...
const Offer = () => {
  const phoneNumbers = [
    { id: 1, number: "+91 91473 89021", href: "tel:+919147389021" },
    { id: 2, number: "+91 91473 89020", href: "tel:+919147389020" },
    { id: 3, number: "+91 91473 89029", href: "tel:+919147389029" },
  ];
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-2/3 mb-8 md:mb-0 px-2">
            <div className="wow slideInUp">
              ...
              <p className="mt-2 text-sm sm:text-base md:text-lg font-open-sans text-amber-950 leading-relaxed">
                Transform your journey with a personal touch. Experience the
                magic of customization and tailor your package as per your
                requirement, because true luxury lies in the little things that
          ...
          <div className="w-full md:w-1/3 tick_double wow zoomIn grid grid-cols-1 sm:grid-cols-2 gap-4 px-2">
            {phoneNumbers.map((phone) => (
              <div
                key={phone.id}
                className="flex items-center p-3 border border-gray-300 rounded-lg bg-white shadow-md hover:shadow-lg transition-shadow"
              >
                <FaPhone className="text-[#603100] text-xl mr-3" />
                <a
                  href={phone.href}
                  className="text-[#603100] font-bold break-words text-sm sm:text-base"
                >
                  {phone.number}
                </a>
              </div>

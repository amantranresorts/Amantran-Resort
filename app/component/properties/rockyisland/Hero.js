...
const leftSideImages = [
  "/images/rocky/top1.jpg",
  "/images/rocky/top2.jpg",
  "/images/rocky/up1.jpg",
];

const rightSideImages = [
  "/images/rocky/up2.jpg",
  "/images/rocky/7.jpg",
  "/images/rocky/8.jpg",
];
  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <section className="bg-gray-100 py-15 hidden md:block">
        <div className="container mx-auto flex flex-row mt-10 bg-[#dfb574] p-1 items-center justify-around shadow-lg">
          {/* Left Side Images */}

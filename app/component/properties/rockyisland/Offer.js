...
const Offer = () => {
    const phoneNumbers = [
        { id: 1, number: "+91-9147389024", href: "tel:+91-9147389024" },
        { id: 2, number: "+91-9147389025", href: "tel:+91-9147389025" },
        { id: 3, number: "+91-9147389029", href: "tel:+91-9147389029" },
    ];

    return (
        <div className="py-12 px-4 sm:px-8 md:px-10 lg:px-20 bg-[#f8f5f0]">

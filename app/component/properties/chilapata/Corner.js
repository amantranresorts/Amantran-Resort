      ...
      <div className="w-full max-w-screen-xl mx-auto mb-16" data-aos="fade-up">
        ...
        <div className="max-w-4xl mx-auto">
          <p className="text-lg md:text-xl text-gray-700 leading-relaxed text-center font-light">
            ...
            . The best hotel in Chilapata, amidst the lush greenery of the
            Chilapata forest, discover a property that blends rustic charm with
            elegant interiors, where every corner tells a story of serene beauty
            and comfort. The soothing ambiance and natural grace will surely
            tempt you to plan your escape to this hidden gem in Chilapata soon.
          </p>
        </div>
      </div>

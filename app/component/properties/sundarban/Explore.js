...
const Explore = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      content:
        "The Bonbibi Temple holds cultural and spiritual significance for the local people of Sundarban. Bonbibi is revered as the protector of the forest and its inhabitants, worshipped by both Hindus and Muslims. The temple symbolizes harmony and respect for nature, making it a must-visit for understanding the region’s deep-rooted spiritual connection with the environment.",
    },
    {
      title: "Godkhali Ferry Ghat",
      content:
        "Godkhali Ferry Ghat is considered the gateway to Sundarban. From here, visitors embark on scenic boat rides through the delta’s winding waterways to reach their resorts and explore various forest zones. It’s the starting point of a tranquil journey into the world’s largest estuarine mangrove ecosystem, offering first glimpses of the serene riverine landscape.",
    },
  ];
  return (

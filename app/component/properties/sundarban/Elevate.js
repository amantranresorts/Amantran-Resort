    ...
    <div className="container mx-auto px-4 sm:px-10 lg:px-40 py-6">
      ...
      <div className="text-left mb-10">
        <h3 className="text-base text-[#d49c45] uppercase font-semibold">
          Reconnect With Nature’s Untamed Grace
        </h3>
        <h2 className="text-3xl md:text-4xl font-raleway mt-2">
          The Best Hotel in Sundarban – Every Room Echoes the Wild
        </h2>
        <p className="text-black font-open-sans mt-4 md:pr-20">
          Discover a sanctuary of calm at Amantran Resort, the best hotel in
          Sundarban, where refined comfort meets the mystical charm of Bengal’s
          mangrove heartland. Our thoughtfully designed rooms offer an immersive
          blend of rustic elegance and eco-conscious luxury, surrounded by the
          calls of the wild and the rhythm of nature. Let the untamed beauty of
          Sundarban awaken your senses in a retreat crafted for both adventure
          and introspection.
        </p>
      </div>

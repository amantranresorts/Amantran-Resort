...
const CheckOut = () => {
  const properties = [
    { name: 'Chilapata', image: '/images/chilapata/hotel1.jpg', link: '/properties/chilapata' },
    { name: 'Rocky Island', image: '/images/rocky.jpg', link: '/properties/rocky-island' },
    { name: 'Sundarban', image: '/images/slide4.jpg', link: '/properties/sundarbon' },
    { name: 'Tarapith', image: '/images/tarapith/out2.jpg', link: '/properties/tarapith' },
  ];

    ...
    <section className="py-12 bg-gray-100">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-10">
          <h3 className="text-xl font-semibold font-cinzel uppercase text-[#dfb574]">
            Tailor Made Packages and Offerings
          </h3>
          <h2 className="text-4xl font-raleway text-gray-800 mt-2">
            Curated Just For You
          </h2>
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
            Transform your journey with a personal touch. Experience the magic
            of customization and tailor your package as per your requirement,
            because true luxury lies in the little things that make it uniquely
            yours.
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          ...
          <p className="text-gray-600 mt-2 max-w-xl mx-auto">
            Fill in the form below and our team shall get in touch with you to
            offer the best deals and packages.
          </p>
          <div className="mt-6">

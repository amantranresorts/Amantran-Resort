...
const sliderData = [
  { 
    ...
    details: 'Located approximately 3.5 km from the sacred Tarapith Temple, offering a peaceful stay for pilgrims and travelers alike.' 
  },
  { 
    id: 2, 
    src: '/images/hotel1.jpg', 
    title: 'Amantran Resorts Chilapata', 
    details: 'Surrounded by the lush Chilapata Forest, this retreat is perfect for wildlife lovers and those seeking tranquility in nature.' 
  },
  { 
    id: 3, 
    src: '/images/rocky.jpg', 
    title: 'Amantran Resorts Rocky Island', 
    details: 'Set in the picturesque village of Rocky Island in the Samsing area, ideal for nature lovers, adventure seekers, and camping enthusiasts.' 
  },
  { 
    id: 4, 
    src: '/images/slide4.jpg', 
    title: 'Amantran Resorts Sundarban', 
    details: 'A riverside retreat close to Sundarban National Park, offering immersive mangrove experiences and serene backwater escapes.' 
  }
]
;
...
const ImageSlider = () => {
  ...
  return (
    <div {...handlers} className="relative w-full h-104 lg:h-screen overflow-hidden">
      <AnimatePresence>
          ...
          return (
            index === current && (
              ...
              >
                ...
                />
                <div className="absolute font-gilda inset-0 bg-black/50 flex flex-col justify-center items-center p-4 md:p-8">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white text-center px-2">{slide.title}</h3>
                  <p className="mt-2 text-base sm:text-lg md:text-xl lg:text-2xl text-white text-center max-w-3xl px-2">{slide.details}</p>
                </div>
              </motion.div>
            )
          );

...
const accommodationsData = [
  {
    ...
    details:
      "Experience the ultimate in luxury with our premium amenities and breathtaking views.",
    phone: "+1234567890",
  },
  {
    id: "chilapata",
    ...
    details:
      "Enjoy spacious rooms with modern decor and exceptional service for a memorable stay.",
    phone: "+2345678901",
  },
  {
    id: "rocky-island",
    ...
    details:
      "Relax in our deluxe accommodations designed for comfort and tranquility.",
    phone: "+3456789012",
  },
  {
    id: "sundarban",
    ...
    details:
      "Our executive suites offer unparalleled luxury with panoramic views and exclusive amenities.",
    phone: "+4567890123",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 text-center sm:text-left">
          ...
          <p className="text-sm sm:text-base md:text-lg font-open-sans text-black mb-4">
            Prioritizing every stay as an unforgettable experience, we welcome
            you to explore the epitome of luxury and comfort, where elegance
            meets top-notch service.
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 font-raleway">
